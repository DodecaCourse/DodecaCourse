    ...
    <v-layout align-center justify-center row>
        <v-flex class="article" xs10>
            ...
            <p>
                ...
                enter your answer and check if you got it right.
            </p>
            <p>By repeatedly
            ...
            <p>In the first 3
                bars a <i>I - IV - V - I</i> progression is played. After that an individual
                note is played. After each note there is a pause where you can enter your answer.</p>
            ...
            <ol>
                ...
                <li><p><b>Try to
                    ...
                    the note's scale degree, sing the syllable on the note.</p></li>
                <li><p><b>Check that
                    you've identified it correctly:</b> enter your answer
                    to check that you identified the scale degree correctly.</p></li>
            </ol>
            <p>Repeat this
