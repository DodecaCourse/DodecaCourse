...
<template>
  ...
  >
    ...
    >
      ...
      <p>
        <b>Bars 1-2:</b>
        Establish one note as the tonic
      </p>
      <p>
        Just like in the
      ...
      <ol>
        ...
        <li>
          <p>
            <b>Sing the
              tonic:</b> Sing the note you hear as the tonic in your head. If you
        ...
        <li>
          <p>
            <b>Repeat:</b> The
            tonic internalisation exercise moves randomly through the keys.
          </p>
        </li>
      </ol>
      <p>
